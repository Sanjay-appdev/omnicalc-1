class ApplicationController < ActionController::Base
  ...
  def payment_results
    @jkl = params.fetch("user_apr").to_f
    @shel = params.fetch("user_years").to_i
    @fan = params.fetch("user_pv").to_f
  ...
  def blank_random_form
    render({:template =>"calculation_templates/blank_random.html.erb" })
  end
